...
SQLALCHEMY_DATABASE_URI = 'mysql://knowledge:local@knowledge-mysql/knowledge'
#SQLALCHEMY_DATABASE_URI = 'mysql+mysqlconnector://knowledge:local@knowledge-mysql/knowledge'
#SQLALCHEMY_DATABASE_URI = 'postgresql://knowledge:local@knowledge-postgres/knowledge'
